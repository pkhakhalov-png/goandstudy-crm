...
// Дефолтный шаблон — только заголовки 12 этапов, пункты пустые.
// Куратор сам заполняет каждый этап под своего клиента.
// При желании может переименовать/удалить/добавить любой этап.
export const DEFAULT_ROADMAP_TEMPLATE: { title: string; items: { title: string }[] }[] = [
  ...
  { title: 'Презентация подборки', items: [] },

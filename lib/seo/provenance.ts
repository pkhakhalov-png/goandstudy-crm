...
const UNIT_TOKENS: Record<string, string[]> = {
  ...
  // Канадский доллар отдельно от американского: на странице IRCC он пишется
  // «CAD $85» и «$CAN», и без своей строки такая сумма подтверждалась бы
  // долларовыми токенами — то есть любой ценой в долларах на любой странице.
  cad: ['cad', 'can$', '$can', 'canadian dollar', 'канадск'],
  eur: ['€', 'eur', 'euro', 'евро'],
  gbp: ['£', 'gbp', 'pound', 'фунт'],

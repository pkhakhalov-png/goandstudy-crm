 ...
 *
 * 17.09.2026: я менял это на «целимся в вечер по Москве» и вернул обратно по
 * просьбе Павла. Действующий SEO-конвейер настроен и работает; решение о часе
 * выпуска принято здесь осознанно, и менять его без замера аудитории незачем.
 * Замер станет возможен, когда наберутся данные attribution_events — тогда
 * это будет предложение с числами, а не догадка.
 */

...
import { INITIAL_RESUME, normalizeResume } from '@/app/client/resume/mock'
import { useDemoState } from '../../DemoState'

export default function DemoResumePrintPage() {
  ...
  const resume = normalizeResume((state.resume as any) || INITIAL_RESUME)

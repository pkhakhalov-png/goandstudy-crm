        ...
        <div style={{ position: 'relative', maxWidth: 1200, margin: '0 auto', padding: '40px 32px 28px' }}>
          ...
          >
            {hasUnlocked ? (
              ...
              <>Если найдём стипендии, подходящие под твой профиль — обязательно предложим. Здесь появятся карточки с дедлайнами, суммой и инструкцией как подать.</>
            )}
          </p>
        </div>
      </section>
        ...
        {!hasUnlocked && (
          <div style={{
            ...
            <div style={{ fontSize: 14, color: 'var(--ds-ink-dim)', maxWidth: 520, margin: '0 auto', lineHeight: 1.5 }}>
              Если найдутся стипендии, подходящие под твой профиль — обязательно предложим.
              Куратор уже смотрит варианты по твоим вузам.
            </div>
          </div>
        )}

...
export default async function CuratorClientsPage() {
  ...
  return (
    <div className="app">
      ...
      <div className="main">
        <div className="topbar"><div className="pt">Мои клиенты</div></div>
        <div style={{ padding: '40px 24px', textAlign: 'center' }}>
          <div style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', color: 'var(--muted)' }}>Клиенты</div>
